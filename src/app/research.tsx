...
import {
  ...
  FaUsers,
  FaChartBar,
} from "react-icons/fa"; // FaEye, FaRobot, FaCertificate, FaChartBar
...
export const researchProjects = [
...

  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?q=80&w=1740&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
...

  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1576400883215-7083980b6193?q=80&w=1626&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          ...
          <div className="row align-items-center">
            <div className="col-lg-8">
              ...
              <p className="lead mb-4 fs-4 text-secondary">
                Pioneering the future of education through technology and
                innovation
              </p>
        ...
        <div className="container-fluid ml-10 mr-10">
          <div className="text-center mb-5">
            ...
            <p className="lead text-muted max-w-800 mx-auto">
              Interdisciplinary projects at the intersection of education and
            ...
            <div className="d-flex justify-content-center mb-4 flex-wrap">
              <div className="btn-group" role="group">
                <button
                  type="button"
                  className={`btn fw-semibold btn-${
                    activeFilter === "all" ? "secondary" : "outline-warning"
                  }`}
                ...
                <button
                  type="button"
                  className={`btn fw-semibold btn-${
                    activeFilter === "ongoing" ? "secondary" : "outline-warning"
                  }`}
          ...
          <div className="row g-4 px-4 px-md-5">
            {filteredProjects.map((project) => (
              <div key={project.id} className="col-lg-6">
                <div
                  className={`project-card card h-100 border-0 shadow-sm overflow-hidden transition-all hover-shadow-lg ${
                    project.status === "ongoing"
                      ? "border-start border-4 border-primary-subtle"
                      : "border-start border-4 border-success-subtle text-dark"
                  }`}
                >
                    ...
                    <div className="d-flex align-items-start gap-4">
                      ...
                      <div className="flex-grow-1">
                        <div className="d-flex justify-content-between align-items-start">
                          <h3
                            className="h4 card-title fw-bold mb-3"
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="text-center p-4">
                ...
                <p className="text-muted">
                  Combining expertise from education, computer science, and
            ...
            <div className="col-md-4">
              <div className="text-center p-4">
                ...
                <p className="text-muted">
                  Rigorous experimental designs with quantitative and
            ...
            <div className="col-md-4">
              <div className="text-center p-4">
                ...
                <p className="text-muted">
                  Direct application in educational settings with measurable
                  outcomes
                </p>
              </div>
            </div>
      ...
      >
        <div className="container text-center py-4">
          ...
          <p className="lead mb-4">
            We welcome collaborations with academia and industry.
          </p>

          <div className="d-flex justify-content-center gap-3">
            <Link to="/#contact">
              <button className="btn btn-light btn-lg px-4">Contact Us</button>
            </Link>
          </div>
        </div>
      </section>
